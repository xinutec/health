...
# Regenerate health's raster icons from the SVG sources in public/.
...
# bites into. This pulse is the closest of the four apps to the line — its flat
# leads run wide — so it is the one most worth measuring.
python3 - <<'PY'
import math, sys
