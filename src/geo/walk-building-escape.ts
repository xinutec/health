...
// snapping a vertex fully onto a way within reach or leaving it exactly where
// the GPS put it — lived here. Deleted 2026-08-17: nothing called it. The walk
// draw goes through `walk-smooth-map.ts`, which has its own
// `nearestWalkablePoint` and its own policy. `nearestWalkable` below STAYS: the
// building-escape path uses it.
